...
from ACDC_trainer import run_main

parser = argparse.ArgumentParser()
parser.add_argument('--train_root_path', type=str,
                    default='/lustre/home/acct-medcb/medcb-cb1/yx/medical data/ACDC', help='root dir for train data')
parser.add_argument('--val_root_path', type=str,
                    default='/lustre/home/acct-medcb/medcb-cb1/yx/medical data/ACDC', help='root dir for val data')
...
parser.add_argument('--img_size', type=int,
                    default=[20, 256, 256], help='input patch size of network input')                 # network input image size : 128
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'ACDC': {
            'train_root_path': '/lustre/home/acct-eeyj/eeyj-wr/youxin/medical_dataset/ACDC',
            'val_root_path': '/lustre/home/acct-eeyj/eeyj-wr/youxin/medical_dataset/ACDC',
    ...
    net = network(in_channel=3, out_channel=args.num_classes, training=True, config=config_vit).cuda()
