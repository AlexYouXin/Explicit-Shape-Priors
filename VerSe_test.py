...
from dataloader.dataset_verse import verse_dataset
from utils.VerSe_utils import test_single_volume
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'VerSe': {
            ...
            'volume_path': '/lustre/home/acct-eeyj/eeyj-wr/youxin/medical_dataset/verse19',
            'list_dir': '/lustre/home/acct-eeyj/eeyj-wr/youxin/shape_prior_module/LG-SPM/Verse/3dunet/lists/lists_Synapse',
            'num_classes': 26,
            'z_spacing': 1,
        },
    }
    ...
    if dataset_name == 'VerSe':  # using max_epoch instead of iteration to control training duration
    ...
    snapshot1 = os.path.join(snapshot_path, 'epoch_1000.pth')
    snapshot2 = os.path.join(snapshot_path, 'epoch_950.pth')
