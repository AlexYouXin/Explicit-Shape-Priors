...
def get_b16_config():
    ...
    config = ml_collections.ConfigDict()
    config.patches = ml_collections.ConfigDict({'size': (16, 16, 16)})     # config.patches = ml_collections.ConfigDict({'size': (16, 16)})
...
def get_r50_b16_config():
    ...
    config.classifier = 'seg'
    config.pretrained_path = '/lustre/home/acct-eeyj/eeyj-wr/youxin/trans3dunet_multi_class/model/vit_checkpoint/imagenet21k/R50+ViT-B_16.npz'
    config.decoder_channels = (256, 128, 64, 16)
